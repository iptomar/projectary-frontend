...
var ProjectFormService = (function () {
    function ProjectFormService(_http) {
        this._http = _http;
        this.apiURL = main_1.API.url;
    }
    ProjectFormService.prototype.getSchool = function () {
        return this._http.get(this.apiURL + '/school')
            .map(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    ProjectFormService.prototype.getCourse = function (id) {
        return this._http.get(this.apiURL + '/course/' + id)
            .map(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    ProjectFormService.prototype.handleError = function (error) {
        return Rx_1.Observable.throw(error.json().error || "Server error");
    };
    ProjectFormService.prototype.postJSON = function (data) {
        console.log(data);
...
exports.ProjectFormService = ProjectFormService;
//# sourceMappingURL=project-form.service.js.map